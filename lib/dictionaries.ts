...
const ko: Dictionary = {
  ...
  work: {
    ...
    projects: [
      ...
      {
        slug: "owis-museum-musiccore-0404",
        youtubeId: "EZoDlUICsm4",
        title: "OWIS 'MUSEUM' — 쇼! 음악중심 (04.04)",
        role: "음악방송 무대",
        year: "2026",
        tags: ["Unreal"],
        description: "2026.04.04 MBC 쇼! 음악중심 무대 영상.",
        accent: 0,
      },
      {
  ...
  work: {
    ...
    projects: [
      ...
      },
      {
        slug: "owis-museum-musiccore-0404",
        youtubeId: "EZoDlUICsm4",
        title: "OWIS 'MUSEUM' — Show! Music Core (04.04)",
        role: "Music Show Stage",
        year: "2026",
        tags: ["Unreal"],
        description: "MBC Show! Music Core stage, aired 2026.04.04.",
        accent: 0,
      },
      {
        slug: "owis-museum-inkigayo",
  ...
  work: {
    ...
    projects: [
      ...
      },
      {
        slug: "owis-museum-musiccore-0404",
        youtubeId: "EZoDlUICsm4",
        title: "OWIS 'MUSEUM' — ショー!音楽中心 (04.04)",
        role: "音楽番組ステージ",
        year: "2026",
        tags: ["Unreal"],
        description: "2026.04.04 MBC ショー!音楽中心ステージ。",
        accent: 0,
      },
      {
        slug: "owis-museum-inkigayo",
  ...
  work: {
    ...
    projects: [
      ...
      },
      {
        ...
        year: "2026",
        tags: ["Unreal"],
        description: "2026.04.04 MBC Show! Music Core 舞台。",
        accent: 0,
      },
      {
        slug: "owis-museum-inkigayo",
